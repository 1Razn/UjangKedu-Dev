        ...
        <div className="detail-main">
          ...
          <div className="detail-specs">
            {property.bedrooms !== undefined && (
              <div className="detail-spec"><div><strong>{property.bedrooms}</strong><span>Kamar Tidur</span></div></div>
            )}
            {property.bathrooms !== undefined && (
              <div className="detail-spec"><div><strong>{property.bathrooms}</strong><span>Kamar Mandi</span></div></div>
            )}
            <div className="detail-spec"><div><strong>{property.area} m²</strong><span>Luas</span></div></div>
            {property.certificate && (
              <div className="detail-spec"><div><strong>{property.certificate}</strong><span>Sertifikat</span></div></div>
            )}
            {property.year && (
              <div className="detail-spec"><div><strong>{property.year}</strong><span>Tahun</span></div></div>
            )}
          </div>
        ...
        <aside className="detail-aside">
          <div className="detail-agent-card">
            <div className="detail-agent-head">
              <div className="detail-agent-avatar">{property.agent ? property.agent.charAt(0) : "A"}</div>
              <div>
